...
namespace CRT
{
	...
	public:
		...
		bool IntersectTriangularSide(Ray _r, Triangle _tr, float& t0, float& t1, float3& inter0, float3& inter1, float3& _bary, float3& _bary1, EGridChange& _startChange, float _tesselation) const;
